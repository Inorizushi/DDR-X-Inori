...
t[#t+1] = Def.ActorFrame{
	...
	--p2
	LoadActor( "Explanation" )..{
		InitCommand=cmd(visible,GAMESTATE:IsHumanPlayer(PLAYER_2);x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y+140;halign,1;zoomx,-1);
		OnCommand=cmd(addx,-SCREEN_WIDTH;sleep,0.5;accelerate,0.5;addx,SCREEN_WIDTH);
		OffCommand=cmd(sleep,0.2;accelerate,0.5;addx,SCREEN_WIDTH);
	};
};
...
if GAMESTATE:IsHumanPlayer(PLAYER_2) then
  t[#t+1] = LoadFont("Common Normal")..{
    InitCommand=cmd(x,SCREEN_CENTER_X+280;y,SCREEN_CENTER_Y+120;zoom,0.5;wrapwidthpixels,494;horizalign,right;valign,0;strokecolor,Color("Black"));
