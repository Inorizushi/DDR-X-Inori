...
LoadActor("ddrx_logobg1")..{
OnCommand=cmd(diffusealpha,0.5;FullScreen;sleep,0.333;decelerate,0.033;zoom,1.02;zoomtowidth,SCREEN_WIDTH*1.02;accelerate,0.033;zoom,1;zoomtowidth,SCREEN_WIDTH;decelerate,0.033;zoom,1.02;zoomtowidth,SCREEN_WIDTH*1.02;accelerate,0.033;zoom,1;zoomtowidth,SCREEN_WIDTH;);
};
...
Def.Quad{
OnCommand=cmd(diffuse,Color.Black;FullScreen;diffusealpha,1;decelerate,0.166;diffusealpha,0);
};

Def.Quad{
OnCommand=cmd(diffuse,Color.Black;FullScreen;diffusealpha,0;sleep,64.5;accelerate,0.5;diffusealpha,1);
};
