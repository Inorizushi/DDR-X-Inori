...
local ret = Def.ActorFrame{
  InitCommand=function(self) self:zoom(1.05):xy(2,115):hibernate(1.25) end,
  OffCommand=function(self) self:sleep(0.25):diffusealpha(0) end;
}
...
for idx, diff in pairs(difficultiesToDraw) do
    ...
    local label = Def.Sprite{
        ...
        InitCommand = function(self) self:setstate(idx-1):SetAllStateDelays(math.huge):diffuse{0.7,0.7,0.7,1} end
    }
